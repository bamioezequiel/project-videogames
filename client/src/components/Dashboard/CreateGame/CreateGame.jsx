...
export default function CreateGame() {
  ...
  const updateGame = useSelector((state) => state.detailGame);
  ...
  const handleCheck = (e, type) => {
    ...
    if (type === "tags") {
      if (e.target.checked && !input.tags.includes(value)) {
        ...
        setInput({
          ...input,
          tags: input.tags.filter((t) => t !== value),
        });
      }
    } else if (type === "genres") {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      errors.released.length ||
      errors.short_screenshots.length ||
      errors.price.length ||
      errors.on_sale.length ||
      errors.tags.length ||
      errors.platforms.length ||
      errors.genres.length
    ) {
      console.log("error");
      return;
    }
    ...
    <div className={s.createGame_container}>
      ...
      <form className={s.createGame_form_container}>
        <div className={s.form_input_group}>
          <label htmlFor="name" className={s.form_input_label}>
            Name
          </label>
          <input
            type="text"
        ...
        <div className={s.form_input_group}>
          <label htmlFor="price" className={s.form_input_label}>
            Price
          </label>
          <input
            type="number"
        ...
        <div className={s.form_input_group}>
          <label htmlFor="on_sale" className={s.form_input_label}>
            On sale
          </label>
          <input
            type="number"
        ...
        <div className={s.form_input_group}>
          <label htmlFor="stock" className={s.form_input_label}>
            Released
          </label>
          <input
            type="date"
        ...
        <div className={s.form_input_group}>
          <label htmlFor="features" className={s.form_input_label}>
            Features
          </label>
          <select
            id="features"
          ...
          >
            ...
            <option selected={input.featured ? true : false} value="true">
              Yes
            </option>
            <option selected={input.featured ? false : true} value="false">
              No
            </option>
          </select>
        </div>
        ...
        <div className={s.form_labels_container}>
          <div className={s.form_checkbox_group}>
            <label className={s.form_input_label}>
        ...
        <button
          onClick={handleReset}
          style={id ? { backgroundColor: "#ffffff33" } : undefined}
